...
class ContactsOld extends DOM_Controller {
    ...
    public function index() {
		...
		if($contacts) :
			...
			foreach($contacts as $contact) {
				$edit_button = '';
				$edit_button .= form_open('/contactsOld/edit',array('name'=>'EditForm','id'=>'contact_' . $contact->ContactID));
				...
				$view_button = '';
				$view_button .= form_open('/contactsOld/view',array('name'=>'ViewContact','id'=>'view_' . $contact->ContactID));
