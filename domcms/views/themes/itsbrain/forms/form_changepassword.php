<div class="uDialog" id="ChangePasswordForm">
    <div id="reset" class="dialog-message" title="Change Password">
        <p><img src="<?= base_url(); ?>assets/themes/itsbrain/imgs/lock50.png" style="float:left;margin:5px;"  alt="Reset Password" />Fill the form out below to change your password back to something easier to remember.</p>
        <div class="uiForm">
            <?php 
