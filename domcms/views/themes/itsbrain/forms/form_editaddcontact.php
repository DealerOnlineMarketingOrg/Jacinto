        ...
        <div class="uiForm">
            ...
            <div class="widget" style="margin-top:-10px;padding-top:0;margin-bottom:10px;">
                <ul class="tabs">
                    ...
                    <li><a href="javascript:void(0);" rel="Website">Websites</a></li>
                ...
                <div class="tab_container">
                                ...
                                <div class="rowElem noborder">
                                    ...
                                    <div class="formRight searchDrop">
                                        <select id="contactType" class="chzn-select validate[required]" style="width:350px" name="type">
                                            <option value="CID" <?= (($contact->TypeCode == 'CID') ? 'selected="selected"' : ''); ?>>Client</option>
                                            <option value="VID" <?= (($contact->TypeCode == 'VID') ? 'selected="selected"' : ''); ?>>Vendor</option>
                                            <option value="GID" <?= (($contact->TypeCode == 'GID') ? 'selected="selected"' : ''); ?>>General</option>
                                        </select>
                                    </div>
                                    <div class="fix"></div>
                                </div>
                                <div class="rowElem noborder">
                                    <div id="contactParentClient" style="<?= (($contact->TypeCode == 'CID') ? '' : 'display:none'); ?>">
                                    ...
                                    <div id="contactParentVendor" style="<?= ($contact->TypeCode == 'VID') ? '' : 'display:none'; ?>">
                                    ...
                                    <div id="contactParentGeneral" style="<?= ($contact->TypeCode == 'GID') ? '' : 'display:none'; ?>">
                                    </div>
                                    <div class="fix"></div>
                                </div>
                                <div class="rowElem noborder">
                    ...
                    <div id="Website" class="tab_content" style="display:none;">
...
<script type="text/javascript">
	...
	jQuery('ul.tabs li a').live('click',function() {
		...
		//alert(content);
		jQuery('#<?= $pageID; ?> div.tab_container div.tab_content').hide();
		jQuery('#<?= $pageID; ?> div.tab_container').find(content).css({'display':'block'});
		//alert(content);
	});
