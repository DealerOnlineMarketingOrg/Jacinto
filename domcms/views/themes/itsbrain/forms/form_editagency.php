        ...
        <fieldset>
            <div class="widget first">
                ...
                <div class="rowElem noborder">
                    ...
                    <div class="formRight"><input type="text" class="required" name="name" id="name"/></div><div class="fix"></div>
                </div>
                <div class="rowElem noborder">
                    <label>Agency Description</label>
                    <div class="formRight">
                        <textarea name="notes" rows="8" cols="" class="auto" name="notes"></textarea>
                    </div>
                    <div class="fix"></div>
                </div>
